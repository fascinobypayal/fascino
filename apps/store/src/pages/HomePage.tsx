...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen pb-20">
      {/* Hero Section */}
      {heroLoading ? (
        <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center bg-muted">
      ...
      <section className="relative h-[85vh] min-h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-16">
          <div className="text-center fade-in-up fade-in-delay-2"><BrandLogo size="xl" /></div>
          {ctaLink ? (
      ...
      {!collectionsLoading && collections.length > 0 && (
        <section className="px-4 py-14">
          <h2 className="text-center font-serif text-2xl tracking-wide mb-2 fade-in">Collections</h2>
