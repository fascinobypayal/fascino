...
const ShopPage = () => {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [products, query, activeCategory, activePriceRange, activeSort]);
            ...
            <div className="bg-background border-b border-border px-4 py-3">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={activeTab === 'collections' ? 'Search collections...' : 'Search products...'}
                  className="w-full bg-muted/40 border border-border rounded-full pl-10 pr-10 py-2.5 text-sm placeholder:text-muted-foreground focus:outline-none focus:border-accent/60 transition-colors"
                  aria-label="Search"
                />
                {search && (
                  <button
